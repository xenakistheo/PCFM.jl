#!/bin/bash
#SBATCH --job-name=pcfm_ns_16
#SBATCH --partition=mit_normal_gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --output=logs/ns_16_%j.out
#SBATCH --error=logs/ns_16_%j.err
