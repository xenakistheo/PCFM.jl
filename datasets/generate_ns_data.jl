...
Output files (written to datasets/data/):
  - ns_nw100_nf100_s32_t50_mu0.001.h5   (train: 10,000 solutions)
  - ns_nw30_nf30_s32_t50_mu0.001.h5     (test:    900 solutions)
"""

include(joinpath(@__DIR__, "generate_ns_2d.jl"))
