...
#
# Output files (written to datasets/data/), matching what train_ffm_ns.jl expects:
#   - ns_nw100_nf100_s16_t50_mu0.001.h5   (train: 10,000 solutions)
#   - ns_nw30_nf30_s16_t50_mu0.001.h5     (test:    900 solutions)
